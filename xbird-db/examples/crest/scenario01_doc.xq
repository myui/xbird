  ...
  <result>
    {
      ...
      return
        let $genbank-remote-entries := 
        	xbird:remote-eval($remote-endpoint, 'fn:doc("file:///D:/workspace/xbird/examples/crest/genbank.xml")/genbank/INSDSeq[INSDSeq_accession-version/text() = $gb-key]', $gb-key)
