...
declare variable $blast2-endpoint := "//uran:1099/xbird/srv-01";
...
let $gb_entry := (for $e in $blast-gb/BlastOutput
                ...
                return $e),
    $uniprot_entry := xbird:remote-eval($blast2-endpoint, 
    				 'for $e in fn:collection("/crest/blast-uniprot.xml")/result/BlastOutput
                     let $hit := $e/BlastOutput_iterations/Iteration/Iteration_hits/Hit
                     where $hit/Hit_num = 1 and $hit/Hit_hsps/Hsp/Hsp_evalue/text() <= 1.0e-8
                     return $e')
