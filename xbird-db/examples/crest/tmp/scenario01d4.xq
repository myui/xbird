...
execute at $remote-endpoint {
	let $blast-gb := fn:collection("/crest/blast-gb.xml")/result,
		$blast-uniprot := fn:collection("/crest/blast-uniprot.xml")/result
	...
	return
      ...
      return
        let $genbank-remote-entries := fn:collection("/crest/genbank.xml")/genbank/INSDSeq[INSDSeq_accession-version/text() = $gb-key]
