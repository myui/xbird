/*
 * @(#)$Id: OpenInt2LongLRUMapTest.java 3619 2008-03-26 07:23:03Z yui $
 *
...
import xbird.util.collections.ints.Int2LongOpenHash.IMapIterator;
import xbird.util.collections.ints.Int2LongOpenHash.Int2LongOpenLRUMap;

public class OpenInt2LongLRUMapTest extends TestCase {

    public OpenInt2LongLRUMapTest() {
        super(OpenInt2LongLRUMapTest.class.getName());
    }

    @Test
    public void testPut() {
        final int limit = 4;
        Int2LongOpenLRUMap lru = new Int2LongOpenLRUMap(4);
        lru.put(0, 1L);
        lru.put(1, 2L);
        lru.put(2, 3L);
        lru.put(3, 4L);
    ...
    public void testGetPromotion() {
        Int2LongOpenLRUMap map = new Int2LongOpenLRUMap(3);
        map.put(1, 1L);
        map.put(2, 2L);
        map.put(3, 3L);
