 ...
 * @version $Rev: 602315 $, $Date: 2007-12-08 13:07:26 +0900 (Sat, 08 Dec 2007) $
 */
public class ExpiringMap<K, V> implements Map<K, V> {
    ...
    private final List<ExpirationListener<V>> expirationListeners;
    ...
    public ExpiringMap(int timeToLive, int expirationInterval, boolean useListener) {
        this(ConcurrentCollectionProvider.<K, ExpiringObject> createConcurrentMap(16), useListener ? new CopyOnWriteArrayList<ExpirationListener<V>>()
                : Collections.<ExpirationListener<V>> emptyList(), timeToLive, expirationInterval);
    }

    private ExpiringMap(ConcurrentMap<K, ExpiringObject> delegate, List<ExpirationListener<V>> expirationListeners, int timeToLive, int expirationInterval) {
    ...
    private final class ExpiringObject {
        private K key;
     ...
     * @version $Rev: 602315 $, $Date: 2007-12-08 13:07:26 +0900 (Sat, 08 Dec 2007) $
     */
    public final class Expirer implements Runnable {
        ...
        private void processExpires() {
            ...
            for(ExpiringObject o : delegate.values()) {
                ...
                if(timeIdle >= timeToLiveMillis) {
                    ...
                    if(!expirationListeners.isEmpty()) {
