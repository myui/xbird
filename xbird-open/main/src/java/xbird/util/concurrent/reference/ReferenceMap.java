 ...
 * 
 * Contributors:
 *     Google Inc.- initial implementation
 *     Makoto YUI - ported
 */
/*
...
import static xbird.util.concurrent.reference.ReferenceType.STRONG;
...
public class ReferenceMap<K, V> extends AbstractMap<K, V>
     ...
     * reference types.
     *
     * @param delegateMap internally used map instance
     * @param keyReferenceType key reference type
     * @param valueReferenceType value reference type
     */
    public ReferenceMap(ConcurrentMap delegateMap, ReferenceType keyReferenceType, ReferenceType valueReferenceType) {
     ...
     */
    protected static boolean referenceEquals(Reference r, Object o) {
