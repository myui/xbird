...
public class LinkedTransferQueue<E> extends AbstractQueue<E>
    ...
    private final PaddedAtomicReference<QNode> head = new PaddedAtomicReference<QNode>(dummy);
    private final PaddedAtomicReference<QNode> tail = new PaddedAtomicReference<QNode>(dummy);
     ...
     * when it cancelled.
     */
    private final PaddedAtomicReference<QNode> cleanMe = new PaddedAtomicReference<QNode>(null);
    ...
    private Object awaitFulfill(QNode pred, QNode s, Object e, int mode, long nanos) {
        ...
        for(;;) {
            ...
            if(spins < 0) {
                ...
                spins = ((h != null && h.next == s) ? (mode == TIMEOUT ? maxTimedSpins
                        : maxUntimedSpins) : 0);
            }
            if(spins > 0)
                --spins;
