 ...
 */
public final class Object2LongOpenHash<K extends Serializable> implements Externalizable {
    ...
    public Object2LongOpenHash(int size) {
        this(size, DEFAULT_LOAD_FACTOR, DEFAULT_GROW_FACTOR);
    }

    @SuppressWarnings("unchecked")
    public Object2LongOpenHash(int size, float loadFactor, float growFactor) {
        if(size < 1) {
    ...
    public Object2LongOpenHash() {// required for serialization
    ...
    public String toString() {
        ...
        buf.append('{');
        final IMapIterator<K> i = entries();
        while(i.next() != -1) {
    ...
    public void writeExternal(ObjectOutput out) throws IOException {
        ...
        final IMapIterator<K> itor = entries();
        int i = 0;
        for(; itor.next() != -1; i++) {
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        final Object[] keys = new Object[keylen];
    ...
    public interface IMapIterator<K> {
    ...
    private final class MapIterator implements IMapIterator<K> {
