/*
 * @(#)$Id: Max.java 3619 2008-03-26 07:23:03Z yui $
 *
 ...
 * fn:max.
 * <DIV lang="en">
 * Selects an item from the input sequence $arg whose value is greater than or equal to
 * the value of every other item in the input sequence.
 * <ul>
 * <li>fn:max($arg as xdt:anyAtomicType*) as xdt:anyAtomicType?</li>
 * <li>fn:max($arg as xdt:anyAtomicType*, $collation as string) as xdt:anyAtomicType?</li>
 * </ul>
 * </DIV>
 * <DIV lang="ja"></DIV>
 * 
 * @author Makoto YUI (yuin405+xbird@gmail.com)
 * @link http://www.w3.org/TR/xquery-operators/#func-max
 */
public final class Max extends BuiltInFunction {
    private static final long serialVersionUID = -2738205430199375189L;
    public static final String SYMBOL = "fn:max";
