/*
 * @(#)$Id: NamespaceUri.java 3619 2008-03-26 07:23:03Z yui $
 *
 ...
 * <ul>
 * <li>fn:namespace-uri() as xs:anyURI</li>
 * <li>fn:namespace-uri($arg as node()?) as xs:anyURI</li>
 * </ul>
 * </DIV>
 * <DIV lang="ja"></DIV>
 * 
 * @author Makoto YUI (yuin405+xbird@gmail.com)
 * @link http://www.w3.org/TR/xquery-operators/#func-namespace-uri
 */
public final class NamespaceUri extends BuiltInFunction {
    private static final long serialVersionUID = -1106668976726497316L;
    public static final String SYMBOL = "fn:namespace-uri";
    ...
    public Sequence eval(Sequence<? extends Item> contextSeq, ValueSequence argv, DynamicContext dynEnv) throws XQueryException {
        ...
        if (argv == null) {
            ...
            node = (XQNode) firstItem.iterator().next();
        }
        final String nsuri;
        if (node.isEmpty()) {
            // If $arg is the empty sequence, the xs:anyURI corresponding to 
