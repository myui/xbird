/*
 * @(#)$Id: ProfiledDocumentTable.java 1834 2007-03-03 10:47:19Z yui $
 *
...
/**
 * A XMLDocumentTable which access pattern to the Document table is profiled
 * to the CSV output.
 * <DIV lang="en"></DIV>
 * <DIV lang="ja"></DIV>
 * 
 ...
 */
public final class ProfiledDocumentTable extends DocumentTable implements IProfiledDocumentTable {
    private static final long serialVersionUID = -1596893241639374496L;
    ...
    public ProfiledDocumentTable(String file) {
        this(new File(file));
    }
