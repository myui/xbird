(:
  -- Qizx
 $ java -Xmx255m -jar "D:\workspace\qizxopen-1.0\lib\qizxopen.jar" -out %3 "D:\workspace\xbird\main\test\resources\org\metabrick\xbird\xquery\parser\data\nodeid01.xq"
:)

declare variable $e1 := element book { "aaa" };
declare variable $e3 := text { "bbb" };
declare variable $e2 := element article { $e1 };

(: implimentation define ? :)
$e3 << $e2/child::node()
