...
for $p in $auction1/site/people/person,
    $t in $auction2/site/closed_auctions/closed_auction
return ($t, $p/@id)(: Stylus Studio meta-information - (c) 2004-2005. Progress Software Corporation. All rights reserved.
<metaInformation>
