            ...
            <xsl:if test='xqtsr:transformation'>
               <tr>
                  <td valign="top" colspan="2">
                     Transformation:
                     <blockquote>
                        <xsl:apply-templates select='xqtsr:transformation/xqtsr:p'/>
                     </blockquote>
                  </td>
               </tr>         
            </xsl:if>
            <xsl:if test='xqtsr:comparison'>
               <tr>
                  <td valign="top" colspan="2">
                     Comparison:
                     <blockquote>
                        <xsl:apply-templates select='xqtsr:comparison/xqtsr:p'/>
                     </blockquote>
                  </td>
               </tr>         
            </xsl:if>
            <xsl:if test='xqtsr:otherComments'>
               <tr>
                  <td valign="top" colspan="2">
                     Other Comments:
                     <blockquote>
                        <xsl:apply-templates select='xqtsr:otherComments/xqtsr:p'/>
                     </blockquote>
                  </td>
               </tr>         
            </xsl:if>
