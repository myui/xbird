...
public final class FastBufferedInputStream extends FilterInputStream {
     ...
     */
    private static final AtomicReferenceFieldUpdater<FastBufferedInputStream, byte[]> bufUpdater = AtomicReferenceFieldUpdater.newUpdater(FastBufferedInputStream.class, byte[].class, "buf");
